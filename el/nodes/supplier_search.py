...
# the only source that covers India-viral items. cj remains importable but off the
# default path (CJ has no India items). Opt back in via EL_SUPPLIER_SOURCES_ENABLED.
